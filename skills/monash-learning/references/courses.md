# Monash S1 2026 - Course Reference
...
### 课程结构
每周分三块：
- **Own-time** — 课前自学任务（Pre-reading Quiz 等）
- **Real-time** — 课堂任务（周二上课时完成）
- **Wrap-up** — 课后总结/提交

### 全学期周计划
| 周次 | 主题 |
|------|------|
| Week 1 | Onboarding - Design Thinking（2-8 Mar） |
| Week 2 | Onboarding - Discovery, Iteration Planning |
| Week 3 | EXPO / Go-Live Onboarding, Retrospective |
| Week 4 | IT for Social Good Research, Industry Mentor Proposal |
| Week 5 | Iteration 1 Quality Assurance & Community of Practice |
| 假期 | During the break |
| Week 6 | Iteration 1 - Go Live, UI/UX |
| Week 7 | Iteration 2, Effort Estimation |
| Week 8 | Iteration 2 Continuous Improvement |
| Week 9 | Iteration 2 Go-live, Quality Assurance, Innovative |
| Week 10 | Iteration 3 - Sense of Belonging, CoP |
| Week 11 | Iteration 3 Go-Live, Handover Package |
| Week 12 | Expo & Learning Journey |

### Week 1 本周任务
**学习目标：** 理解 Design Thinking 原则；培养成长型思维
**本周必做：**
...
| 日期 | 任务 | 权重 |
|------|------|------|
| 3/5 23:55 | Week 1 Pre-reading Quiz | - |
| 3/5 23:55 | Problem Statement Submission | - |
| 3/8 23:55 | Quiz on the Student Guide | - |
| 3/8 23:55 | Consent Forms | - |
| 3/9 23:55 | Week 2 Pre-reading Quiz | - |
| 3/15 | Assignment 1 - Part A - Quiz 1 | 2% |
| 3/17 | Onboarding Team Reflection [PGP] | - |
| 3/26 | Self Reflection Check-in (Feedback Fruits) | - |
| 3/26 | Proposal to Industry Mentor Showcase [PGP] | 10% |
| 3/27 | Assignment 1 - Part D - Resource Analysis | 5% |
| 3/29 | Reflective Diary Week1-4 [Moodle] | - |

### 所有作业类型
**1. Work Integrated（项目类）**
- Onboarding Team Reflection [PGP]
- Proposal to Industry Mentor Showcase [PGP] — 10%
- Iteration 1 / 2 / 3
- Handover Package [PGP]
- Learning Journey Video [PGP]

**2. Written（书面类）**
- Reflective Diary Week1-4 [Moodle]
- Reflective Diary Week5-8 [Moodle]
- Portfolio Discipline Reflection - **MAI** [In-person by appointment]（一航是 Master of AI）

**3. Quiz/Test**
- Week 1 Pre-reading Quiz
- Week 2 Pre-reading Quiz

### 重要资源链接
- Student Guide 2026 S1: https://learning.monash.edu/mod/resource/view.php?id=5325412
- Week by Week Schedule: https://learning.monash.edu/mod/resource/view.php?id=5325413
- Assessment Schedule: https://learning.monash.edu/mod/resource/view.php?id=5325429
- Iteration Rubric: https://learning.monash.edu/mod/resource/view.php?id=5325446
