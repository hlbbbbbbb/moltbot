...
export function registerOnboardCommand(program: Command) {
  program
    ...
    .option(
      "--auth-choice <choice>",
      "Auth: setup-token|token|chutes|openai-codex|openai-api-key|openrouter-api-key|ai-gateway-api-key|moonshot-api-key|kimi-api-key|kimi-code-api-key|synthetic-api-key|venice-api-key|gemini-api-key|zai-api-key|apiKey|minimax-api|minimax-api-lightning|opencode-zen|skip",
    )
    .option(
      "--token-provider <id>",
    ...
    .option("--moonshot-api-key <key>", "Moonshot API key (Global)")
    .option("--kimi-api-key <key>", "Kimi API key (中国版 api.moonshot.cn)")
        ...
        await onboardCommand(
          {
            ...
            kimiApiKey: opts.kimiApiKey as string | undefined,
